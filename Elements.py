...
time.sleep(0.5)
print("\n1. Find the Symbol of an Element")
time.sleep(0.5)
print("\n3. Find the atomic number of an Element(by symbol)")
time.sleep(0.5)
print("\n3. Find the atomic number of an Element(by name)")
time.sleep(0.5)


#Element = str(input("Enter an Element(or 0 to quit)"))